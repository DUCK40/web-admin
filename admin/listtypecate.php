                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="listtypecate.php" class="mm-active">
                                    <i class="">
                                    </i>List TypeCategory
                                </a>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <h5 class="card-title">TypeCategory</h5>
        ...
        <script>
            $(document).ready(function() {
                ...
                function loadtable() {
                    ...
                    $.get(url_global + '/api/v1_0/master/gettabletypecate').done(function(jsonData) {
                        ...
                        if (jsonData['STATUS'] == 1) {
                            ...
                            if (dataRes.length != 0) {
                                for (var i = 0; i < dataRes.length; i++) {
                                    ...
                                    append = append + "<td class='typecatecode'>" + TYPE_CATE_CODE + "</td>"
                                    append = append + "<td class='typecatenameth'>" + TYPE_CATE_NAME_TH + "</td>"
                                    append = append + "</tr>"
                                }
